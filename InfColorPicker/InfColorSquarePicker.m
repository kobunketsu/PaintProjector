...
- (void) layoutSubviews
{
	...
	if( indicator == nil ) {
        ...
        indicator.accessibilityLabel = @"ColorPicker SV Picker";
    ...
    indicatorMagnify.center = CGPointMake(pointRoot.x, pointRoot.y - indicatorMagnify.bounds.size.height*0.25);
