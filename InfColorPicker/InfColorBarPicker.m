...
- (void) layoutSubviews
{
	...
	if( indicator == nil ) {
        ...
        indicator.accessibilityLabel = @"ColorPicker Hue Picker";
    ...
    CGPoint pointRoot = [self convertPoint:indicator.center toView:rootView];
    indicatorMagnify.center = CGPointMake(pointRoot.x, pointRoot.y - self.indicatorMagnify.bounds.size.height*0.5);        
    indicatorMagnify.backgroundColor = indicator.color;
}
					  ...
					  withEvent: (UIEvent*) event
{
    ...
    self.indicatorMagnify.hidden = false;	
	return YES;
}
...
- (void)endTrackingWithTouch:(UITouch *)touch withEvent:(UIEvent *)event{
    self.indicatorMagnify.hidden = true;	
}
//------------------------------------------------------------------------------
