...
- (void)layoutSubviews{
    ...
    if (self.arrowDirection == UIPopoverArrowDirectionUp) {
        ...
        self.textLabel.frame = CGRectMake(CGRectGetMinX(frame) + 16, CGRectGetMinY(frame) + 7, CGRectGetWidth(frame) - 23, CGRectGetHeight(frame) - 14);
        
    }
    else if (self.arrowDirection == UIPopoverArrowDirectionRight) {
        self.textLabel.frame = CGRectMake(CGRectGetMinX(frame) + 6, CGRectGetMinY(frame) + 7, CGRectGetWidth(frame) - 22, CGRectGetHeight(frame) - 14);
...
- (void)targetView:(UIView *)targetView inRootView:(UIView*)rootView{
    ...
    DebugLogWarn(@"frame %@", NSStringFromCGRect(frame));
...
- (void)drawBubbleButtonWithFrameLeft: (CGRect)frame offsetPercent:(CGFloat)percent;
{
    ...
    //// Subframes
    CGRect frame2 = CGRectMake(CGRectGetMinX(frame), CGRectGetMinY(frame) + floor((CGRectGetHeight(frame) - 20) * percent + 0.5), 24, 20);
    
    
    //// Bezier Drawing
    UIBezierPath* bezierPath = UIBezierPath.bezierPath;
    [bezierPath moveToPoint: CGPointMake(CGRectGetMaxX(frame) - 2.15, CGRectGetMinY(frame) + 8.2)];
    [bezierPath addLineToPoint: CGPointMake(CGRectGetMaxX(frame) - 2.25, CGRectGetMinY(frame) + 7.81)];
    [bezierPath addCurveToPoint: CGPointMake(CGRectGetMaxX(frame) - 7.79, CGRectGetMinY(frame) + 2.25) controlPoint1: CGPointMake(CGRectGetMaxX(frame) - 3.18, CGRectGetMinY(frame) + 5.23) controlPoint2: CGPointMake(CGRectGetMaxX(frame) - 5.21, CGRectGetMinY(frame) + 3.19)];
    [bezierPath addCurveToPoint: CGPointMake(CGRectGetMaxX(frame) - 16.72, CGRectGetMinY(frame) + 1.5) controlPoint1: CGPointMake(CGRectGetMaxX(frame) - 10.15, CGRectGetMinY(frame) + 1.5) controlPoint2: CGPointMake(CGRectGetMaxX(frame) - 12.34, CGRectGetMinY(frame) + 1.5)];
    [bezierPath addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 26.68, CGRectGetMinY(frame) + 1.5)];
    [bezierPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 18.13, CGRectGetMinY(frame) + 2.15) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 22.3, CGRectGetMinY(frame) + 1.5) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 20.11, CGRectGetMinY(frame) + 1.5)];
    [bezierPath addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 17.75, CGRectGetMinY(frame) + 2.25)];
    [bezierPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 12.21, CGRectGetMinY(frame) + 7.81) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 15.17, CGRectGetMinY(frame) + 3.19) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 13.14, CGRectGetMinY(frame) + 5.23)];
    [bezierPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 11.46, CGRectGetMinY(frame) + 16.79) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 11.46, CGRectGetMinY(frame) + 10.18) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 11.46, CGRectGetMinY(frame) + 12.38)];
    [bezierPath addLineToPoint: CGPointMake(CGRectGetMinX(frame2) + 11.46, CGRectGetMinY(frame2) + 0.63)];
    [bezierPath addLineToPoint: CGPointMake(CGRectGetMinX(frame2) + 2.5, CGRectGetMinY(frame2) + 9.63)];
    [bezierPath addLineToPoint: CGPointMake(CGRectGetMinX(frame2) + 11.46, CGRectGetMinY(frame2) + 18.63)];
    [bezierPath addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 11.46, CGRectGetMaxY(frame) - 16.79)];
    [bezierPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 12.11, CGRectGetMaxY(frame) - 8.2) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 11.46, CGRectGetMaxY(frame) - 12.38) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 11.46, CGRectGetMaxY(frame) - 10.18)];
    [bezierPath addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 12.21, CGRectGetMaxY(frame) - 7.81)];
    [bezierPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 17.75, CGRectGetMaxY(frame) - 2.25) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 13.14, CGRectGetMaxY(frame) - 5.23) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 15.17, CGRectGetMaxY(frame) - 3.19)];
    [bezierPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 26.68, CGRectGetMaxY(frame) - 1.5) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 20.11, CGRectGetMaxY(frame) - 1.5) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 22.3, CGRectGetMaxY(frame) - 1.5)];
    [bezierPath addLineToPoint: CGPointMake(CGRectGetMaxX(frame) - 16.72, CGRectGetMaxY(frame) - 1.5)];
    [bezierPath addCurveToPoint: CGPointMake(CGRectGetMaxX(frame) - 8.17, CGRectGetMaxY(frame) - 2.15) controlPoint1: CGPointMake(CGRectGetMaxX(frame) - 12.34, CGRectGetMaxY(frame) - 1.5) controlPoint2: CGPointMake(CGRectGetMaxX(frame) - 10.15, CGRectGetMaxY(frame) - 1.5)];
    [bezierPath addLineToPoint: CGPointMake(CGRectGetMaxX(frame) - 7.79, CGRectGetMaxY(frame) - 2.25)];
    [bezierPath addCurveToPoint: CGPointMake(CGRectGetMaxX(frame) - 2.25, CGRectGetMaxY(frame) - 7.81) controlPoint1: CGPointMake(CGRectGetMaxX(frame) - 5.21, CGRectGetMaxY(frame) - 3.19) controlPoint2: CGPointMake(CGRectGetMaxX(frame) - 3.18, CGRectGetMaxY(frame) - 5.23)];
    [bezierPath addCurveToPoint: CGPointMake(CGRectGetMaxX(frame) - 1.5, CGRectGetMaxY(frame) - 16.79) controlPoint1: CGPointMake(CGRectGetMaxX(frame) - 1.5, CGRectGetMaxY(frame) - 10.18) controlPoint2: CGPointMake(CGRectGetMaxX(frame) - 1.5, CGRectGetMaxY(frame) - 12.38)];
    [bezierPath addLineToPoint: CGPointMake(CGRectGetMaxX(frame) - 1.5, CGRectGetMinY(frame) + 16.79)];
    [bezierPath addCurveToPoint: CGPointMake(CGRectGetMaxX(frame) - 2.15, CGRectGetMinY(frame) + 8.2) controlPoint1: CGPointMake(CGRectGetMaxX(frame) - 1.5, CGRectGetMinY(frame) + 12.38) controlPoint2: CGPointMake(CGRectGetMaxX(frame) - 1.5, CGRectGetMinY(frame) + 10.18)];
    [bezierPath closePath];
    CGContextSaveGState(context);
    [bezierPath addClip];
    CGRect bezierBounds = CGPathGetPathBoundingBox(bezierPath.CGPath);
...
- (void)drawBubbleButtonWithFrameRight: (CGRect)frame offsetPercent:(CGFloat)percent;
{
    ...
    //// Subframes
    CGRect frame2 = CGRectMake(CGRectGetMinX(frame) + CGRectGetWidth(frame) - 24, CGRectGetMinY(frame) + floor((CGRectGetHeight(frame) - 20) * percent + 0.5), 24, 20);
    
    
    //// Bezier Drawing
    UIBezierPath* bezierPath = UIBezierPath.bezierPath;
    [bezierPath moveToPoint: CGPointMake(CGRectGetMinX(frame) + 2.15, CGRectGetMinY(frame) + 8.2)];
    [bezierPath addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 2.25, CGRectGetMinY(frame) + 7.81)];
    [bezierPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 7.81, CGRectGetMinY(frame) + 2.25) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 3.19, CGRectGetMinY(frame) + 5.23) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 5.23, CGRectGetMinY(frame) + 3.19)];
    [bezierPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 16.79, CGRectGetMinY(frame) + 1.5) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 10.18, CGRectGetMinY(frame) + 1.5) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 12.38, CGRectGetMinY(frame) + 1.5)];
    [bezierPath addLineToPoint: CGPointMake(CGRectGetMaxX(frame) - 26.79, CGRectGetMinY(frame) + 1.5)];
    [bezierPath addCurveToPoint: CGPointMake(CGRectGetMaxX(frame) - 18.2, CGRectGetMinY(frame) + 2.15) controlPoint1: CGPointMake(CGRectGetMaxX(frame) - 22.38, CGRectGetMinY(frame) + 1.5) controlPoint2: CGPointMake(CGRectGetMaxX(frame) - 20.18, CGRectGetMinY(frame) + 1.5)];
    [bezierPath addLineToPoint: CGPointMake(CGRectGetMaxX(frame) - 17.81, CGRectGetMinY(frame) + 2.25)];
    [bezierPath addCurveToPoint: CGPointMake(CGRectGetMaxX(frame) - 12.25, CGRectGetMinY(frame) + 7.81) controlPoint1: CGPointMake(CGRectGetMaxX(frame) - 15.23, CGRectGetMinY(frame) + 3.19) controlPoint2: CGPointMake(CGRectGetMaxX(frame) - 13.19, CGRectGetMinY(frame) + 5.23)];
    [bezierPath addCurveToPoint: CGPointMake(CGRectGetMaxX(frame) - 11.5, CGRectGetMinY(frame) + 16.79) controlPoint1: CGPointMake(CGRectGetMaxX(frame) - 11.5, CGRectGetMinY(frame) + 10.18) controlPoint2: CGPointMake(CGRectGetMaxX(frame) - 11.5, CGRectGetMinY(frame) + 12.38)];
    [bezierPath addLineToPoint: CGPointMake(CGRectGetMaxX(frame2) - 11.5, CGRectGetMinY(frame2) + 0.63)];
    [bezierPath addLineToPoint: CGPointMake(CGRectGetMaxX(frame2) - 2.5, CGRectGetMinY(frame2) + 9.63)];
    [bezierPath addLineToPoint: CGPointMake(CGRectGetMaxX(frame2) - 11.5, CGRectGetMinY(frame2) + 18.63)];
    [bezierPath addLineToPoint: CGPointMake(CGRectGetMaxX(frame) - 11.5, CGRectGetMaxY(frame) - 16.79)];
    [bezierPath addCurveToPoint: CGPointMake(CGRectGetMaxX(frame) - 12.15, CGRectGetMaxY(frame) - 8.2) controlPoint1: CGPointMake(CGRectGetMaxX(frame) - 11.5, CGRectGetMaxY(frame) - 12.38) controlPoint2: CGPointMake(CGRectGetMaxX(frame) - 11.5, CGRectGetMaxY(frame) - 10.18)];
    [bezierPath addLineToPoint: CGPointMake(CGRectGetMaxX(frame) - 12.25, CGRectGetMaxY(frame) - 7.81)];
    [bezierPath addCurveToPoint: CGPointMake(CGRectGetMaxX(frame) - 17.81, CGRectGetMaxY(frame) - 2.25) controlPoint1: CGPointMake(CGRectGetMaxX(frame) - 13.19, CGRectGetMaxY(frame) - 5.23) controlPoint2: CGPointMake(CGRectGetMaxX(frame) - 15.23, CGRectGetMaxY(frame) - 3.19)];
    [bezierPath addCurveToPoint: CGPointMake(CGRectGetMaxX(frame) - 26.79, CGRectGetMaxY(frame) - 1.5) controlPoint1: CGPointMake(CGRectGetMaxX(frame) - 20.18, CGRectGetMaxY(frame) - 1.5) controlPoint2: CGPointMake(CGRectGetMaxX(frame) - 22.38, CGRectGetMaxY(frame) - 1.5)];
    [bezierPath addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 16.79, CGRectGetMaxY(frame) - 1.5)];
    [bezierPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 8.2, CGRectGetMaxY(frame) - 2.15) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 12.38, CGRectGetMaxY(frame) - 1.5) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 10.18, CGRectGetMaxY(frame) - 1.5)];
    [bezierPath addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 7.81, CGRectGetMaxY(frame) - 2.25)];
    [bezierPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 2.25, CGRectGetMaxY(frame) - 7.81) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 5.23, CGRectGetMaxY(frame) - 3.19) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 3.19, CGRectGetMaxY(frame) - 5.23)];
    [bezierPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 1.5, CGRectGetMaxY(frame) - 16.79) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 1.5, CGRectGetMaxY(frame) - 10.18) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 1.5, CGRectGetMaxY(frame) - 12.38)];
    [bezierPath addLineToPoint: CGPointMake(CGRectGetMinX(frame) + 1.5, CGRectGetMinY(frame) + 16.79)];
    [bezierPath addCurveToPoint: CGPointMake(CGRectGetMinX(frame) + 2.15, CGRectGetMinY(frame) + 8.2) controlPoint1: CGPointMake(CGRectGetMinX(frame) + 1.5, CGRectGetMinY(frame) + 12.38) controlPoint2: CGPointMake(CGRectGetMinX(frame) + 1.5, CGRectGetMinY(frame) + 10.18)];
    [bezierPath closePath];
    CGContextSaveGState(context);
