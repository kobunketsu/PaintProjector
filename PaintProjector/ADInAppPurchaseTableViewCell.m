...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    ADProductFeatureCollectionViewCell *cell = nil;
    if (collectionView.tag == 0) {
        static NSString *cellIdentifier = @"productFeatureCollectionViewCell2";
        cell = (ADProductFeatureCollectionViewCell *)[collectionView dequeueReusableCellWithReuseIdentifier:cellIdentifier forIndexPath:indexPath];
        self.brushPreview.hidden = true;
        self.pageControl.hidden = true;
        
        switch (indexPath.row) {
            case 0:
                cell.imageView.image = [UIImage imageNamed:@"iap_brushDevices.png"];
                productFeatureDescription = NSLocalizedString(@"ProductFeature2Description0", nil);
                productFeatureTitle = NSLocalizedString(@"ProductFeature2Title0", nil);
                break;
        }
    }
    else if (collectionView.tag == 1) {
        ...
        switch (indexPath.row) {
            ...
            case 1:
                ...
                cell.colorButton1.color = [UIColor colorWithRed:1 green:1 blue:1 alpha:1];
                ...
                cell.colorButton4.color = [UIColor colorWithRed:0 green:0 blue:0 alpha:1];
                break;
            case 2:
