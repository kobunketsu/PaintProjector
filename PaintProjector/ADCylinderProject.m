...
//    DebugLogWarn(@"rotateMatrix radian %.2f", radian);
...
- (id)copyWithZone:(NSZone *)zone{
    ADCylinderProject *cylinderProject = (ADCylinderProject *)[super copyWithZone:zone];
