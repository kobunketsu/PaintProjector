...
@interface ADBrushTypeViewController ()

@end

@implementation ADBrushTypeViewController
...
- (id)initWithStyle:(UITableViewStyle)style
{
    ...
    if (self) {
        ...
        UITableView *tv = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, 130, 320)
