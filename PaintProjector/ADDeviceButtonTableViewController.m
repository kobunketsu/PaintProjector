//
//  ADDeviceButtonTableViewController.m
//  PaintProjector
//
...
@interface ADDeviceButtonTableViewController ()

@end

@implementation ADDeviceButtonTableViewController
...
- (void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPathConnectDeviceCellNum
{
...
{
    return PopoverTableViewCellHeight * ConnectDeviceCellNum / (float) Shortcut_Count;
}
@end
