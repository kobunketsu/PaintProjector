...
- (id)copyWithZone:(NSZone *)zone{
    RETransform *transform = (RETransform *)[super copyWithZone:zone];
...
- (void)setEulerAngles:(GLKVector3)eulerAngles{
    ...
    _rotate = [ADMathHelper quatFromEulerAngles:eulerAngles];
    
    self.dirty = true;
}

- (void)setParent:(RETransform *)parent{
    _parent = parent;
...
- (void)setDirty:(BOOL)dirty{
    ...
    for (RETransform *transform in self.childs) {
