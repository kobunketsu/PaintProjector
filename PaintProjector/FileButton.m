...
- (void)drawNormal{
    ...
    //// Color Declarations
    UIColor* gradientColor = [UIColor colorWithRed: 0.851 green: 0.851 blue: 0.851 alpha: 1];
    UIColor* shadowColor2 = [UIColor colorWithRed: 0.832 green: 0.832 blue: 0.832 alpha: 0.516];
    UIColor* gradientCylinderProjectColor = [UIColor colorWithRed: 0.594 green: 0.594 blue: 0.594 alpha: 1];
    UIColor* gradientCylinderProjectColor2 = [UIColor colorWithRed: 0.693 green: 0.693 blue: 0.693 alpha: 1];
    UIColor* gradientColor2 = [UIColor colorWithRed: 0.257 green: 0.257 blue: 0.257 alpha: 1];
    UIColor* gradientColor3 = [UIColor colorWithRed: 0 green: 0 blue: 0 alpha: 1];
