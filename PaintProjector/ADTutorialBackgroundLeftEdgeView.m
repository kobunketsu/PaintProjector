//
//  TutorialBackgroundHardLightView.m
//  PaintProjector
//
...
@implementation ADTutorialBackgroundLeftEdgeView
...
- (void)drawCanvas1WithFrame: (CGRect)frame;
{
    ...
    //// Subframes
    CGRect group = CGRectMake(CGRectGetMinX(frame) + 10, CGRectGetMinY(frame) + 10, 20, CGRectGetHeight(frame) - 20);
    ...
    //// Group
    {
        ...
        UIBezierPath* rectanglePath = [UIBezierPath bezierPathWithRoundedRect: rectangleRect byRoundingCorners: UIRectCornerTopLeft | UIRectCornerBottomLeft cornerRadii: CGSizeMake(10, 10)];
