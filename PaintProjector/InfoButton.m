...
-(void)drawNormal{
    ...
    //// Color Declarations
    UIColor* color2 = [UIColor colorWithRed: 0.693 green: 0.693 blue: 0.693 alpha: 0.529];
    UIColor* fillColor = [UIColor colorWithRed: 0 green: 0 blue: 0 alpha: 1];
    UIColor* strokeColor = [UIColor colorWithRed: 1 green: 1 blue: 1 alpha: 0.49];
    UIColor* shadowColor3 = [UIColor colorWithRed: 0.525 green: 0.525 blue: 0.525 alpha: 1];
