...
//        CGContextDrawLinearGradient(context, gradientPink, CGPointMake(self.bounds.size.width * 0.5 , self.bounds.size.height), CGPointMake(self.bounds.size.width * 0.5, -0), 0);
