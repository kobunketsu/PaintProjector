...
@implementation ADBrushTypeButton
...
{
    // Drawing code
    if ([self.brush isKindOfClass:[ADPencil class]]) {
        [self drawPencil];
    }
    else if ([self.brush isKindOfClass:[ADEraser class]]) {
        [self drawEraser];
    }
    else if ([self.brush isKindOfClass:[ADPen class]]) {
        [self drawPen];
    }
    ...
    else if ([self.brush isKindOfClass:[ADChineseBrush class]]) {
        [self drawChineseBrush];
    }
    else if ([self.brush isKindOfClass:[ADCrayons class]]) {
        [self drawCrayons];
    }
    else if ([self.brush isKindOfClass:[ADBucket class]]) {
        [self drawBucket];
    }
    else if ([self.brush isKindOfClass:[AdInkPen class]]) {
        [self drawInkPen];
    }
    else if ([self.brush isKindOfClass:[ADMarkerSquare class]]) {
        [self drawMarkerSquare];
    }
    else if ([self.brush isKindOfClass:[ADOilBrush class]]) {
        [self drawOilBrush];
    }
    else if ([self.brush isKindOfClass:[ADAirBrush class]]) {
        [self drawAirBrush];
    }
    else if ([self.brush isKindOfClass:[ADChalk class]]) {
        [self drawChalk];
    }
