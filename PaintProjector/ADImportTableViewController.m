...
@implementation ADImportTableViewController
...
- (void)viewDidAppear:(BOOL)animated{
    [Flurry logEvent:@"PS_inImport" withParameters:nil timed:true];
}
- (void)viewDidDisappear:(BOOL)animated{
    [Flurry endTimedEvent:@"PS_inImport" withParameters:nil];
}
...
//    }
    ...
    switch(indexPath.row) { // assuming there is only one section
        ...
        case 1:
            ...
            cell.imageView.image = [UIImage imageNamed:@"camera-48.png"];
            break;
//        case 2:
