...
@implementation ADLayerBlendModeTableViewController
...
- (void)viewDidLoad
{
    ...
    ADLayerBlendModeTableView* layerBlendModeTableView = (ADLayerBlendModeTableView*)self.tableView;
    layerBlendModeTableView.controller = self;
    
    //初始化透明度
    ADLayerOpacitySlider* layerOpacitySlider = [[ADLayerOpacitySlider alloc]initWithFrame:CGRectMake(0, 0, self.tableView.bounds.size.width, UISliderDefaultHeight)];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    ADLayerBlendModeTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:CellIdentifier];
    if (cell == nil) {
        cell = [[ADLayerBlendModeTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:CellIdentifier];
